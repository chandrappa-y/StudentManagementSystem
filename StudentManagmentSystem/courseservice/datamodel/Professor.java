...
public class Professor {
	...
	public Professor(long professorId, String firstName, String lastName, String department, String joiningDate) {
	...
	public String toString() {
		return "Professor Id = " + getProfessorId() + ", First Name = " + getFirstName() + ", Last Name = "
				+ getLastName() + ", department = " + getDepartment() + ", joiningDate = " + getJoiningDate();
	}
